...
while inicio <= fim:
    ...
    if numero == numero_procurado:
        ...
        print(f"Tentativas na pesquisa binária: {tentativas}")
        break

    elif numero < numero_procurado:
        inicio = meio + 1
...
print(f"Tentativas na pesquisa sequencial: {tentativas_sequencial}")
